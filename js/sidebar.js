...
function getFiltered() {
  let filtered = (_state.currentIdxList || []).map(i => ({ idx: i, match: _state.matches[String(i)] }));
  if (_state.searchQ) {
...
export function closeDetail() { document.getElementById('detail').style.display = 'none'; }
